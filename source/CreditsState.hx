...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			[''],
			["Funkin' Crew"],
			['ninjamuffin99',		'fnf/ninjamuffin99',	"Programmer of Friday Night Funkin'",							'https://twitter.com/ninja_muffin99',	'CF2D2D'],
			['PhantomArcade',		'fnf/phantomarcade',	"Animator of Friday Night Funkin'",								'https://twitter.com/PhantomArcade3K',	'FADC45'],
			['evilsk8r',			'fnf/evilsk8r',			"Artist of Friday Night Funkin'",								'https://twitter.com/evilsk8r',			'5ABD4B'],
			['kawaisprite',			'fnf/kawaisprite',		"Composer of Friday Night Funkin'",								'https://twitter.com/kawaisprite',		'378FC7']
		];
	...
	override function update(elapsed:Float)
	{
		...
		if(!quitting)
		{
			...
			if(controls.ACCEPT && (creditsStuff[curSelected][3] == null || creditsStuff[curSelected][3].length > 4)) {
				var ret = callOnMenuScript("onCreditsOpen", [creditsStuff[curSelected]]);
				if(ret != FunkinLua.Function_Stop) CoolUtil.browserLoad(creditsStuff[curSelected][3]);
			}
			if (controls.BACK)
			{
				if(colorTween != null) {
	...
	function changeSelection(change:Int = 0)
	{
		...
		if(ret != FunkinLua.Function_Stop) {
			...
			#if desktop
			// Updating Discord Rich Presence
			DiscordClient.changePresence("In the Credits Menu (" + creditsStuff[curSelected][0] + ")", null);
			#end
