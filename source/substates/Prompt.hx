...
typedef PromptOptions = {
	@:optional var textSize:Int;
	@:optional var textColor:FlxColor;
	@:optional var textYOffset:Int;
	@:optional var textXOffset:Int;
}
...
class Prompt extends MusicBeatSubstate
{
	...
	public function new(promptText:String = '', defaultSelected:Int = 0, okCallback:Void->Void, cancelCallback:Void->Void,
		acceptOnDefault:Bool = false, option1:Null<String> = null, option2:Null<String> = null, ?additionalProps:PromptOptions = null) 
	{
		this.selected = defaultSelected;
		this.okc = okCallback;
		this.cancelc = cancelCallback;
		this.theText = promptText;
	...
	override public function create():Void 
	{
		...
		if(goAnyway) {
			...
			*/
			...
			if(options != null && options.textSize != null) textshit.size = options.textSize;
			if(options != null && options.textColor != null) textshit.color = options.textColor;
			if(options != null && options.textYOffset != null) textshit.offset.y = options.textYOffset;
			if(options != null && options.textXOffset != null) textshit.offset.x = options.textXOffset;
