...
class CoolUtil
{
	...
	/*
	 * Capitalizes the first letter of the string, easy enough.
	 */
	...
	inline public static function listFromString(string:String):Array<String> {
		return [for(item in string.trim().split('\n')) item.trim()];
	}
	*/
	...
	/*
	 * Floors a float to contain a limited amount of decimals.
	...
	**/
	...
	public static function safeSetProperty(obj:Dynamic, prop:String, newValue:Dynamic) {
		if(Reflect.getProperty(obj, prop) != null)
			Reflect.setProperty(obj, prop, newValue);
	}

	public static function safeGetProperty(obj:Dynamic, prop:String, fallbackValue:Dynamic):Dynamic {
		if(Reflect.getProperty(obj, prop) != null) return Reflect.getProperty(obj, prop);
