...
class Paths
{
	...
	inline public static var LUA_EXT:String = ".lua";
	inline public static var HSCRIPT_EXT:String = ".hx";
	...
	{
		return getPath(key + LUA_EXT, TEXT, library);
	}
	...
	inline static public function ndll(key:String) {
		#if MODS_ALLOWED
		var file:String = modsNdll(key + "-" + backend.util.NdllUtil.os + ".ndll");
		if(FileSystem.exists(file)) {
			return file;
		}
		#end
		return 'assets/ndlls/$key.ndll';
	}
	#end

	inline static public function getStateScripts(folder:String):Array<String> {
		return Mods.directoriesWithFile('', 'states/$folder/');
	}
	...
	*/
	...
	public static function loadAnimateAtlas(spr:FlxAnimate, folderOrImg:Dynamic, spriteJson:Dynamic = null, animationJson:Dynamic = null)
	{
		...
		if(spriteJson != null)
		{
			...
			spriteJson = #if sys File.getContent(spriteJson) #else OpenFlAssets.getText(spriteJson) #end;
		}

		if(animationJson != null) 
		{
			changedAnimJson = true;
			animationJson = #if sys File.getContent(animationJson) #else OpenFlAssets.getText(animationJson) #end;
		}
