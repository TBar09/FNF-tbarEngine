...
class Mods
{
	public static var onModChange(default, null):FlxTypedSignal<(ModsList)->Void> = new FlxTypedSignal<(ModsList)->Void>();
	...
	public static var ignoreModFolders:Array<String> = [
		...
		'images',
		'stages',
		#if AWAY3D_ALLOWED 'models', #end
		#if NDLL_ALLOWED 'ndlls', #end
		#if(HSCRIPT_ALLOWED && SOFTCODED_STATES) 'states', #end
