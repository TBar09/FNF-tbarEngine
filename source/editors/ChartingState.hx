...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	inline function set_crashSaveEnabled(value:Bool):Bool {
		if(value) Main.FridayGame.onGameCrash = (errMsg, crashDump) -> crashSave();
		else Main.FridayGame.onGameCrash = null;
		return value;
	}
	#end
	...
	#if CRASH_HANDLER var save_on_crash:FlxUICheckBox; #end
	function addChartingUI() {
		...
		#if CRASH_HANDLER
		save_on_crash = new FlxUICheckBox(mouseScrollingQuant.x + 110, mouseScrollingQuant.y, null, null, "Autosave Chart on Crash", 100,
			function() {
