...
class Paths
{
	...
	inline static public function getStateScripts(folder:String):Array<String> {
		...
		if(Paths.currentModDirectory != null && Paths.currentModDirectory.length > 0) foldersToCheck.insert(0, Paths.mods(Paths.currentModDirectory + '/states/' + folder + '/'));

		for(mod in Paths.getGlobalMods()) foldersToCheck.insert(0, Paths.mods(mod + '/states/' + folder + '/'));
