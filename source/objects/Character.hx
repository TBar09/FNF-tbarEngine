...
class Character extends FlxSprite
{
	...
	**/
	...
	public var hasLoopAnimations:Bool = false;
	...
	public function new(x:Float, y:Float, ?character:String = 'bf', ?isPlayer:Bool = false)
	{
		...
		if(animOffsets.exists('singLEFT-loop') || animOffsets.exists('singDOWN-loop') || animOffsets.exists('singUP-loop') || animOffsets.exists('singRIGHT-loop'))
			hasLoopAnimations = true;
	...
	override function update(elapsed:Float)
	{
		...
		if(hasLoopAnimations) {
			var name:String = getAnimationName();
			//if(isAnimationFinished() && !name.endsWith("-loop") && animOffsets.exists('$name-loop'))
